# Android SMS gateway over GSM using ADB on Arch-linux and Google Pixel 6 with Android 13
#
...
# OTW: for wireless adb control (NOT SECURE!)
...
#adb shell am start -a android.intent.action.SENDTO -d sms:+15555555555 --es sms_body "$txt" --ez exit_on_sent false;
#sleep 1;
